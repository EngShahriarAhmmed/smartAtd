...
export default function SessionsPage(){
  ...
  const load = useCallback(async () => {setLoading(true); const res=await fetch(`/api/admin/sessions?date=${date}`); const data=await res.json(); setLogs(data.logs||[]); setLoading(false)}, [date]);
